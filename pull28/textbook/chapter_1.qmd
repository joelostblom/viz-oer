...
maye the addition of two strings
...
<!-- <details><summary>Click to expand the optional deep dive or proceed to the exercises.</summary> -->
...
<!-- it can be helpful to be aware of which others are avaialble --> 
...
<!--         base -1-> grid -->
<!--         grid -1-> lattice & ggplot -->
<!--         lattice & ggplot -1-> patchwork -->
<!--         ggplot -.-> ggiraph & ggplotly -->
<!--         ggplotly -1-> plotly_r -->
<!--         htmlwidgets -1-> ggiraph & plotly_r & altair_r -->
<!--     end -->
...
<!--         matplotlib -1-> plotnine & pandas & seaborn & holoviz -->
<!--         holoviz -1-> bokeh -->
<!--         plotly_py -1-> plotly_express -->
<!--         vegalite -1-> altair & altair_r -->
<!--     end -->

<!--     %% Connections between ecosystems -->
<!--     js -1-> htmlwidgets & bokeh & plotly_py -->
<!-- ``` -->
...
<!-- <!-1- #| echo: false -1-> -->
<!-- <!-1- api = "{{< env URL >}}" -1-> -->
<!-- <!-1- ojs_define(apiUrl = api) -1-> -->
<!-- <!-1- ``` -1-> -->

<!-- <!-1- ```{ojs} -1-> -->
<!-- <!-1- //| echo: false -1-> -->
<!-- <!-1- import {createChatInterface} from "./chat.js" -1-> -->

<!-- <!-1- { -1-> -->

<!-- <!-1- const instructions = "You are Minister Reed of the city of Viridia, a sharp-witted, impatient but supportive environmental minister. Your colleague has been tasked with creating an Emissions Report. Guide them toward understanding why a complete picture is necessary and why including the Total Food Supply (kg/capita/yr) column matters (alongside the Emissions Kg CO2 / kg product). Once you get a satisfactory answer, end the conversation immediately and ask them to proceed to the next task. You are in a phone text convo."; -1-> -->

<!-- <!-1- const first_message = "I need your Emissions Report on my desk by 2 pm. Remind me why you are including the Total Food Supply in your analysis?"; -1-> -->

<!-- <!-1- const chatInterface = createChatInterface({ -1-> -->
<!-- <!-1-   apiUrl, -1-> -->
<!-- <!-1-   instructions: instructions, -1-> -->
<!-- <!-1-   firstMessage: first_message, -1-> -->
<!-- <!-1-   bossImage: '/img/environ_minister.jpg', -1-> -->
<!-- <!-1-   bossName: 'Minister Reed', -1-> -->    
<!-- <!-1-   maxTokens: 100 -1-> -->
<!-- <!-1- }); -1-> -->

<!-- <!-1- return html`${chatInterface}`; -1-> -->
