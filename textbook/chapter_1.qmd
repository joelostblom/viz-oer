...
By declarative,
we mean that you can provide a high-level specification of *what* you want the visualization to include, rather than having to specify *how* to implement the visualization.
...
Declarative visualization tools let you think about **data and relationships**, rather than **plot construction details.** 


You simply have to declare links between data variables (e.g., dollars spent) and visual encoding channels (e.g., the x-axis, y-axis, color, *etc*). The rest of the plot details are handled automatically. 

Building on this declarative plotting idea, a surprising range of simple to sophisticated visualizations can be created using a concise grammar. This approach makes it very easy to change between plot types, or accomodate changes in your underlying data. 


::: {.callout-note icon="false"}
## Exercise
 Inspect this visualization of the size of petals in Iris flowers. Try to spot the difference in  the code between the declarative and imperative approaches.
...
The declarative code focusses on what we want to visualize (e.g., `petalLength`, `petalLength`) rather than how to construct the visualization (e.g., defining colors, using for loops).  
::: 
<br>
