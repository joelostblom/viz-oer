...
Other high level libraries like seaborn and plotly use a top-down approach, focusing on the type of plot to build rather than building from the data. Both approaches have their benefits, but this course emphasizes the grammar-based, bottom-up approach due to its flexibility and power.
