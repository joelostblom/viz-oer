...
<!--TODO Should there be more LOs? Such as good number of colors? -->
...
::: {.callout-note}
If we are interested in comparing groups for a single continuous variable (such as `percentage_heavy_drinkers` above), position is often the most effective grouping method.
If we are interested in comparing groups while visualizing a pairwise relationship between two continuous variables
:::
